		...
		<div class="row">
			...
			<div class="col-sm-12">
                ...
                <div class="work-header">
                    ...
                    <p>Feel free to browse through Painting By Freddy photo gallery to get the best ideas for Painting solutions including residential and commercial painting.</p>
					...
					<div class="col-md-3 col-sm-6"> 
						...
						{else}
							...
							<a class="folio-item example-image-link mysliderdata" data-id="{$row['id']}" data-toggle="modal" data-target=".bs-example-modal-lg">
								...
								<div style="float: right;position: relative;right: 0px;top: 0px;background-color: rgb( 247, 145, 34 );color:white;z-index: 1000;margin-bottom: -20px;padding-right: 10px;padding-left: 10px;"></div>
...
{literal}
<script src="https://bathroomsbyfreddy.co.uk/resources/js/lightbox-plus-jquery.min.js"></script>
{/literal}


{literal}
<script src="https://dev.bathroomsbyfreddy.co.uk/resources/js/swiper.min.js"></script>
{/literal}
{literal}
<script type="text/javascript">
	...
	$(document).on("click", ".mysliderdata", function () {
		...
		$.ajax({
                ...
                url         : 'https://dev.bathroomsbyfreddy.co.uk/helpers/get_slider_data.php',  
	...
	<div class="modal-dialog modal-lg" role="document">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -12px !important;"><span aria-hidden="true">&times;</span></button>
