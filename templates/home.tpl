	...
	<div class="container-fluid">
    	<div class="col-md-6">
			<div class="leftbanner">
				...
				<a href="{$smarty.const.siteurl}/get-quote/" class="quote">GET QUOTE</a>
			</div>
		</div>
		<div class="col-md-6">
			<div class="rightbanner">
				<div  class="animated bounce scroll">
					<img src="{$smarty.const.root_img}bathrooms.png" class="img-responsive">
				</div>	
			</div>	
		</div>
	...
	<div class="container-fluid">
    	<div class="col-md-4">
        	<div class="specialists">
                <div class="specialists-box" >
					<div  class="imgA">
						<img src="{$smarty.const.root_img}group.png" class="img-responsive">
					</div>
		...
		<div class="col-md-4">
        	<div class="specialists">
                <div class="specialists-box" >
					<div  class="imgA">
						<img src="{$smarty.const.root_img}inspection.png" class="img-responsive">
					</div>
		...
		<div class="col-md-4">
        	<div class="specialists">
                <div class="specialists-box" >
					<div  class="imgA">
						<img src="{$smarty.const.root_img}sticky-notes.png" class="img-responsive">
					</div>
...
<div class="grid">
	...
	<div class="col-md-6">
		<div class="leftpage">
		<img src="{$smarty.const.root_img}bathroom-img1.png" class="img-responsive">
		</div>	
	</div>	
	<div class="col-md-6">
		<div class="rightpage">
	...
	<div class="col-md-12">
		...
		<div class="work-list">
			<div class="repair-list">
				...
				<div class="rightpage">
				<img src="{$smarty.const.root_img}bathrooms-works.png" class="img-responsive img-works f-right">
				</div>
				<div class="clear"></div>
			</div>
	...
	<div class="container-fluid"> 
		<div class="achievement">
			...
			<div class="box" >
				...
				<p><img src="{$smarty.const.root_img}5-star.png"></p>
				<p><a href="#" class="links">Know more</a></p>
			</div>
...
<div class="grid">
	<div class="container-fluid"> 
		...
		<div class="col-lg-4 col-md-4 col-sm-6 wow fadeInUp usbox">
			<div class="uleft">
				<div class="imgss f-left"><img src="{$smarty.const.root_img}new-bathrooms.png" ><p>NEW BATHROOMS </p></div>
				...
				<p><a href="{$smarty.const.siteurl}new-bathrooms-and-ensuite" class="links">Know more &#8594;</a></p>
				</div>
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-6 wow fadeInUp usbox">
			<div class="ucenter">
					<div class="imgss f-left"><img src="{$smarty.const.root_img}new-reno.png" ><p>RENOVATION </p></div>
				...
				<p><a href="{$smarty.const.siteurl}bathroom-renovations-and-extensions" class="links">Know more &#8594;</a></p>
				</div>	
			</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-6 wow fadeInUp usbox">
			<div class="uright">
						<div class="imgss f-left"><img src="{$smarty.const.root_img}new-repair.png" ><p>REPAIRS </p></div>
				...
				<p><a href="{$smarty.const.siteurl}bathroom-repairs-and-maintenance" class="links">Know more &#8594;</a></p>
				</div>
			</div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}tiling.png" >
				</div>
				<div class="f-right">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}masonry.png" >
				</div>
				<div class="f-right">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}floors.png" >
				</div>
				<div class="f-right">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}glass.png" >
				</div>
				<div class="f-right">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}plumbing.png" >
				</div>
				<div class="f-right">
			...
			<div class="slide sbox">
				<div class="f-left">
					<img src="{$smarty.const.root_img}basins.png" >
				</div>
				<div class="f-right">
...
<div class="whyus">
	...
	<div class="container-fluid"> 
		<div class="col-lg-6">
			<img src="{$smarty.const.root_img}why-us.png" class="img-responsive">
		</div>
		<div class="col-lg-6">
			<div class="title-page">
...
<div class="footer-area">
	...
	<div class="container-fluid"> 
		<div class="col-lg-4">
			...
			<div class="area-l">
				<img src="{$smarty.const.root_img}call_us-1.png" class="f-left">
		...
		<div class="col-lg-4">
			<div class="area-r">
				<img src="{$smarty.const.root_img}point.png" class="f-left">
				<div class="areaP f-left">
