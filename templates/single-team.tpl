...
<section id="single-info">
	...
	<div class="container">
    	<h2 class="ourmate-title"><span>{$row['name']}</span></h2>
        <div class="row">
        	<div class="col-md-8">
            	<h4>ABOUT ME</h4>
                <p>{$row['about_us']}</p>
            ...
            <div class="col-md-4">
            	<div class="single-dp">
                	<img src="{if !empty($row['image'])}https://trade.byfreddy.io/photo/tradesman/_thumb/{$row['image']}{/if}{if empty($row['image'])}{$smarty.const.root_img}profile.png{/if}" alt="{$row['name']}">
                </div>
            </div>
            <div class="col-md-12">
	...
	<div class="single-tab-nav"><a data-toggle="tab" class="active" href="#mywork">My Work</a>  | <a data-toggle="tab" href="#testimonials">Testimonials</a> | <a data-toggle="tab" href="#jobs">Jobs</a></div>
      ...
      <div class="tab-content">
        <div id="mywork" class="tab-pane fade in active">
        	...
        	<div class="col-md-3">
            	<a class="folio-item example-image-link mysliderdata" data-id="{$work['id']}" data-toggle="modal" data-target=".bs-example-modal-lg">
                	<img src="{if !empty($work['top_img'])}https://admin.byfreddy.io{$work['top_img']}{/if}{if empty($work['top_img'])}{$smarty.const.root_img}work1.jpg{/if}" class="example-image">
                    	<div class="item-info">
                        	<div class="eli-width">
                            	<p class="truncate title"><strong>{$work['title']|truncate:40}</strong></p>
                                <p class="truncate location"><i class="fa fa-map-marker" aria-hidden="true"></i> {$work['location']|truncate:40}</p>
                            </div>
                        </div>
               </a>
            </div>
        ...
        <div id="jobs" class="tab-pane fade">
        	<div class="col-sm-3">
            	<div class="single-jobs">
            		{if !empty($row['totalquoted'])}
            		<div class="single-jobs-amount">{$row['totalquoted']}</div>
...
{/if}
        	...
        	<div class="col-sm-3">  
            	<div class="single-jobs">
                	<div class="single-jobs-amount">{$row['work']|@count}</div>
                    <h3>My Work</h3>
                </div>
            </div>
            <div class="clearfix"></div>
