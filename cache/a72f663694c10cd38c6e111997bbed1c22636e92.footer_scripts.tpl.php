...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5ec1306f5fa365_65482448',
...
function content_5ec1306f5fa365_65482448 (Smarty_Internal_Template $_smarty_tpl) {
?>
                                    ...
                                    <li style="width: 29%;">
                                        ...
                                        <div style="height:36px;width:120px;" class="abcRioButton abcRioButtonLightBlue" onclick="signinfacebook()">
                                            <div class="abcRioButtonIcon" style="padding:8px">
                                                <div style="width:18px;height:18px;" class="abcRioButtonSvgImageWithFallback abcRioButtonIconImage abcRioButtonIconImage18"><img src="https://bathroomsbyfreddy.co.uk/resources/img/facebook.png"></div>
                                            </div>
...
@media screen and (min-width: 768px) {
  .dropdown:hover>.dropdown-menu {
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-130793969-7"></script>
    <script>
