...
require "../config.inc.php";
 ...
 $site_root="https://professionalfreddy.com/";
...
$assoc_query = "SELECT * from siteassociate where id = 6";
$assoc_result = mysql_query($assoc_query);
$accoc_row = mysql_fetch_array($assoc_result);
...
// $sqll = "INSERT INTO `clients` (`id`, `username`, `password`, `first_name`, `last_name`, `email`, `phone`, `mobile`, `address`, `subrub`, `date`) VALUES (NULL, '1', '', '', '', '', '', '', '', '', '');";
   ...
   echo $last_id = mysql_insert_id($sqll);
...
///Send Email 
      ...
      $sqlp2 = "SELECT * FROM notification_email WHERE id = 5";
        $resultp2 = mysql_query($sqlp2) or die(mysql_error());
