...
$chk_address = $_POST['chk_show_hide'];

if($chk_address!=1){
  $address2 =  $_POST['first_line'].' '.$_POST['second_line'].' '.$_POST['third_line'].' '.$_POST['post_town'];
...
$dealname2 = $name." - ".$_POST['post_town']." - ".$subrub; 
...
$api_token = "892cb104b8628fb85165236daef44d41ad09229a";
...
$person = array(
 ...
 '21821ace8e72a61dda693f0b925379606b04a10d' => $_POST['first_line'].' '.$_POST['second_line'].' '.$_POST['third_line'].' '.$_POST['post_town'],

 '5deab41e45d762fa377460da8fee689e73c1bd71' => '27',

 'postal_address' => $_POST['first_line'].' '.$_POST['second_line'].' '.$_POST['third_line'].' '.$_POST['post_town']
...

{
  ...
  if (!empty($result['data']['id'])) {
     ...
     $person_follower_id = $result['data']['id'];
...
// echo	file_get_contents("https://www.smsglobal.com/http-api.php?action=sendsms&user=$user&password=$pass&from=$from&to=$to&text=$msg");
...
file_get_contents("https://api.smsglobal.com/http-api.php?action=sendsms&user=$user&password=$pass&from=$from&to=$to&text=$text&maxsplit=2");
...
$l1= $_POST['first_line'];
$l2= $_POST['second_line'];
$l3= $_POST['third_line'];
$pt= $_POST['post_town'];
   GLOBAL $conn;
     $sqlperson = "UPDATE pipedrive_person SET ctry ='UNITED KINGDOM' , company='160' , client_type='clients' , post_town = '$pt' , address_line1='$l1' , address_line2 ='$l2' , address_line3 ='$l3' WHERE id='$my_p_id' ";
