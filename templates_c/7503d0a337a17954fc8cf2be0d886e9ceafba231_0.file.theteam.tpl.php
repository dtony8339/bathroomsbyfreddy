<?php
/* Smarty version 3.1.31, created on 2020-05-17 11:17:34
  from "/home/ukbathroomsbyfr/public_html/templates/theteam.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5ec11d4e78d4a5_11606134',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7503d0a337a17954fc8cf2be0d886e9ceafba231' => 
    array (
      0 => '/home/ukbathroomsbyfr/public_html/templates/theteam.tpl',
      1 => 1559287083,
      2 => 'file',
    ),
  ),
...
function content_5ec11d4e78d4a5_11606134 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
          ...
          <div class="col-lg-3 col-sm-6 teamfreddyitem">
              <div class="teamfreddy">
                  <div class="teamfreddy-img" style="background-image:url('<?php if (!empty($_smarty_tpl->tpl_vars['row']->value['image'])) {?>https://trade.byfreddy.io/photo/tradesman/_thumb/<?php echo $_smarty_tpl->tpl_vars['row']->value['image'];
}
if (empty($_smarty_tpl->tpl_vars['row']->value['image'])) {
echo @constant('root_img');?>
teamfreddy-1.jpg<?php }?>');height: 250px;">
                    </div>
                    <div class="teamfreddy-info">
                      <p class="teamfreddy-name"><?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
</p>
                        <p class="teamfreedy-loc"><i class="fa fa-map-marker"></i><?php if (!empty($_smarty_tpl->tpl_vars['row']->value['trade_area'])) {?> <?php echo $_smarty_tpl->tpl_vars['row']->value['trade_area'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['row']->value['city'];?>
 <?php }?></p>
                    </div>
                </div>
                <center><button type="button" class="btn btn-primary teamfreddy-button" data-toggle="modal" data-target="#team<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
">
                  View
                </button></center>
            </div>
...
<div class="modal fade teamfreddy-modal" id="team<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="profile-img"><img src="<?php if (!empty($_smarty_tpl->tpl_vars['row']->value['image'])) {?>https://trade.byfreddy.io/photo/tradesman/_thumb/<?php echo $_smarty_tpl->tpl_vars['row']->value['image'];
}
if (empty($_smarty_tpl->tpl_vars['row']->value['image'])) {
echo @constant('root_img');?>
teamfreddy-1.jpg<?php }?>" alt="" class="img-responsive"></div>
          ...
          <div class="col-md-8">
            ...
            <div class="profile-info">
              ...
              <!-- <p class="stats"><strong>Name</strong> --> <!-- <?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
 --><!-- </p> -->
              ...
              <p><?php echo $_smarty_tpl->tpl_vars['row']->value['about_us'];?>
                            ...
                            <a href="/theteam/<?php echo $_smarty_tpl->tpl_vars['row']->value['trade_area'];?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
">Read More <i class="fa fa-external-link" aria-hidden="true"></i></a>

              <!-- <p class="stats"><strong>Title</strong> <?php echo $_smarty_tpl->tpl_vars['row']->value['company_name'];?>
</p> -->
...
work1.jpg<?php }?>" alt="">
                  ...
                  <div class="mate-work-info">
                    ...
                    <p class="mate-work-name"><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['work']->value['title'],40);?>
</p>

                    <p class="mate-work-location"><i class="fa fa-map-marker"></i> <?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['work']->value['location'],40);?>
</p>
            ...
            <div class="row">
              ...
              <div class="col-md-12" align="center">
                ...
                <div class="mate-link">
                  ...
                  <a class="customButton" href="/theteam/<?php echo $_smarty_tpl->tpl_vars['row']->value['trade_area'];?>
/<?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
">View More</a>
...
<!-- <footer>
 ...
 type="text/javascript">document.write(new Date().getFullYear());<?php echo '</script'; ?>
> ByFreddy.CO.UK    Terms and conditions   Privacy notice   Cookie policy<br>
...
.top-banner.ourteam {
  ...
  background: url('<?php echo @constant('root_img');?>
team-freddy.jpg');
