<?php
/* Smarty version 3.1.31, created on 2020-05-17 11:17:19
  from "/home/ukbathroomsbyfr/public_html/templates/get-quote.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5ec11d3fb2ee39_80521735',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5e26ddafb2dabf62870fdf7e8a60fcc0996b8195' => 
    array (
      0 => '/home/ukbathroomsbyfr/public_html/templates/get-quote.tpl',
      1 => 1555306716,
      2 => 'file',
    ),
  ),
...
function content_5ec11d3fb2ee39_80521735 (Smarty_Internal_Template $_smarty_tpl) {
?>
<style>
...
<?php echo '<script'; ?>
 src="<?php echo @constant('siteurl');?>
resources/js/postcodes.min.js"><?php echo '</script'; ?>
>
    ...
    <form action="#" method="POST" id="pipefrom" class="Individual-form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                 ...
                 <?php $_smarty_tpl->_assignInScope('printed', array());
?>
                ...
                <select type="text" style="width:100%" id="code" name="code" class="form-control form-lg">
                    ...
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['mobile_code']->value, 'code');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['code']->value) {
?>

                        <?php if (!isset($_smarty_tpl->tpl_vars['printed']->value[$_smarty_tpl->tpl_vars['code']->value->country])) {?>   

                            <!--  $client_country_name  -->

                            <option  value="+<?php echo $_smarty_tpl->tpl_vars['code']->value->country_code;?>
" <?php if ($_smarty_tpl->tpl_vars['code']->value->country_code == '+44') {?> selected="selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['code']->value->country;?>
 (+<?php echo $_smarty_tpl->tpl_vars['code']->value->country_code;?>
)</option>
...
?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <label class="checkbox-inlinex">
                                ...
                                <input name="product[]" type="checkbox" value=<?php echo $_smarty_tpl->tpl_vars['row']->value['name'];?>
>
